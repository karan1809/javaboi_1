...
// Define the range of questions you want to retrieve
$start_question = 11; // Starting question ID
$end_question = 20;   // Ending question ID

// Calculate the offset and limit for the query
$offset = $start_question - 1; // Subtract 1 to match array indexing
$limit = $end_question - $start_question + 1; // Calculate the number of questions to retrieve

// Fetch questions and options from the database within the specified range
$quiz_query = "SELECT * FROM quizzes LIMIT $offset, $limit";
